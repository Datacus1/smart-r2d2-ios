...
DRIVE = {
    "stop": bytes([0x18, 0x14]),
    "forward": bytes([0x17, 0x01, 0xE8, 0x03]),
    "backward": bytes([0x17, 0x01, 0xE9, 0x03]),
    "left": bytes([0x17, 0x01, 0xEA, 0x03]),
    "right": bytes([0x17, 0x01, 0xEB, 0x03]),
    "backward-left": bytes([0x17, 0x01, 0xEC, 0x03]),
    "backward-right": bytes([0x17, 0x01, 0xED, 0x03]),
}
